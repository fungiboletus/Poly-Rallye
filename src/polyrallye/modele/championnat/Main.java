...
//        
//        LE.get(0).setClassement(new Duree(0,5,21,9), StockVoitures.getVoitureParNom("Peugeot 307 WRC"));
//        LE.get(1).setClassement(new Duree(0,5,21,9), StockVoitures.getVoitureParNom("Ferrari Enzo serie"));
//        
//        System.out.println("---------------------------");
//        
...
//           LE.get(i).EnregistrerEtape(LE.get(i)); 
        ...
        Championnat Champ = Championnat.chargerChampionnat("championnat européen");
        Champ.setClassement();
    }
}
